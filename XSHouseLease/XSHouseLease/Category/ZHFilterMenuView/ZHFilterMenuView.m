                                     ...
                                     confirmAction:(SEL _Nonnull )confirmAction
{
    if (self = [super init]) {
        ...
        UIColor *nom = [UIColor hx_colorWithHexStr:@"#444444"];
        UIColor *sel = [UIColor hx_colorWithHexStr:@"#EB4040"];

        self.resetButton = [UIButton buttonWithType:UIButtonTypeCustom];
        self.resetButton.frame = CGRectMake(20, 10, CGRectGetWidth(self.frame) / 2 - 20, CGRectGetHeight(self.frame) - 20);
        [self.resetButton setTitle:@"重置" forState:UIControlStateNormal];
        [self.resetButton setTitleColor:nom forState:UIControlStateNormal];
        [self.resetButton setBackgroundColor:[UIColor whiteColor]];
        self.resetButton.layer.masksToBounds = YES;
        self.resetButton.layer.cornerRadius = 8;
        self.resetButton.layer.borderColor = nom.CGColor;
        ...
        self.confirmButton.frame = CGRectMake(CGRectGetWidth(self.frame) / 2 + 20, 10, CGRectGetWidth(self.frame) / 2 - 20, CGRectGetHeight(self.frame) - 20);
        ...
        [self.confirmButton setBackgroundColor:sel];
...
- (void)animateMenuViewWithShow:(BOOL)show
{
    ...
    if (show) {
        ...
        if (confirmType == ZHFilterMenuConfirmTypeBottomConfirm) {
            ...
            self.bottomView.resetButton.frame = CGRectMake(20, 10, CGRectGetWidth(self.bottomView.frame) / 2 - 40, 0);
            self.bottomView.confirmButton.frame = CGRectMake(CGRectGetWidth(self.bottomView.frame) / 2 + 20, 10, CGRectGetWidth(self.bottomView.frame) / 2 - 40, 0);
        ...
        [UIView animateWithDuration:0.3 animations:^{
            ...
            if (confirmType == ZHFilterMenuConfirmTypeBottomConfirm) {
                ...
                self.bottomView.resetButton.frame = CGRectMake(20, 10, CGRectGetWidth(self.bottomView.frame) / 2 - 40, CGRectGetHeight(self.bottomView.frame) - 20);
                self.bottomView.confirmButton.frame = CGRectMake(CGRectGetWidth(self.bottomView.frame) / 2 + 20, 10, CGRectGetWidth(self.bottomView.frame) / 2 - 40, CGRectGetHeight(self.bottomView.frame) - 20);
            }
        }];
        [self.leftTableView reloadData];
        [self.rightTableView reloadData];
