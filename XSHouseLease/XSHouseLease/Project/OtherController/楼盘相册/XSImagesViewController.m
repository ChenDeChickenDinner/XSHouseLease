...
- ( NSArray<NSString *>*)getTitlese{
    ...
    for (XSHouseDetailsDataImgsModel *dataModel  in self.imgs) {
...
- (NSArray<id<JXCategoryListContentViewDelegate>>*)getListVc{
    XSImageListViewController *vc = [[XSImageListViewController alloc]init];
    vc.array = self.imgs;
...
- (void)setImgs:(NSArray<XSHouseDetailsDataImgsModel *> *)imgs{
    _imgs = imgs;
}
